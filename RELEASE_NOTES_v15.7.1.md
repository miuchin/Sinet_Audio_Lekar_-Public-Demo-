# SINET Audio Lekar — v15.7.1 (FINAL PATCH)
...
### 3.1 Version string bump na 15.7.1

- `index.html` i `index-nosw.html`: title i UI label
- `js/app.js`: `SINET_APP_VERSION = "15.7.1"`

### 3.2 Service Worker cache bump

- `service-worker.js`: `CACHE_NAME` je promenjen na **sinet-audio-v15.7.1**
- `ASSETS_TO_CACHE` query stringovi su usklađeni na `?v=15.7.1`
...
- Podsetnici / alarms su planirani za naredni release (nije deo v15.7.1).
...
- `RELEASE_NOTES_v15.7.1.md` (ovaj fajl)
