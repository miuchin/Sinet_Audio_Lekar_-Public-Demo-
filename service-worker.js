...
// v15.7.1.4 — cache key bump (prevents stale SW cache)
const CACHE_NAME = 'sinet-audio-v15.7.1.4';
...
const ASSETS_TO_CACHE = [
  ...
  './js/db/indexed-db.js?v=15.7.1.4',
  './js/app.js?v=15.7.1.4',
  './js/audio/audio-engine.js?v=15.7.1.4',
  './js/audio/ios-rendered-track.js?v=15.7.1.4',
  './js/catalog/stl-adapter.js?v=15.7.1.4',
